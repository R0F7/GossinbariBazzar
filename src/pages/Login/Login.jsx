    ...
    return (
        <div className='flex justify-center items-center min-h-screen bg-[#F3F8FC] shadow-2xl relative z-50 overflow-hidden '>
                ...
                <div className='bg-[#FFFFFF] w-[470px] shadow-lg rounded-xl'>
                    ...
                    <div>
                        <form onSubmit={handleSubmit} className='flex flex-col'>
                            ...
                            <button type="submit" className="cursor-pointer bg-[#2E8DD8] shadow-lg shadow-[rgba(46,141,216,.25)] mx-14 py-2.5 my-6 text-white font-semibold rounded-md transform duration-150 active:scale-95 scale-100">Sign In</button>
                        </form>
                    </div>
                    <div className='text-center py-5 bg-[#F3F8FC] rounded-b-xl'>
                        <span className='italic'>Not registered? <Link to='/signup' className='underline hover:text-[#2E8DD8] font-medium'>Create an account</Link></span>
                    </div>
                </div>
            </div>
            ...
            <div className='w-full h-full absolute top-[495px] left-0 overflow-hidden -z-50'>
                <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none" ><path d="M985.66,92.83C906.67,72,823.78,31,743.84,14.19c-82.26-17.34-168.06-16.33-250.45.39-57.84,11.73-114,31.07-172,41.86A600.21,600.21,0,0,1,0,27.35V120H1200V95.8C1132.19,118.92,1055.71,111.31,985.66,92.83Z" className="shape-fill" fill="#FAE286" fillOpacity="1"></path></svg>
            </div>
        </div>
