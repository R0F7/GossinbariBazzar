            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex gap-">
                <div>
                  ...
                  <h4 className="text-slate-600 font-bold">UID : <span className="font-semibold">{user?.providerData[0]?.uid}</span></h4>
                  <h4 className="text-slate-600">{user?.email}</h4>
                </div>

                <div
                  onClick={() => setToggle(!toggle)}
                  className="w-10 h-10 p-2 ml-2 rounded-full hover:bg-white hover:bg-opacity-30 transition duration-500 flex items-center justify-center text-xl"
                >
                  {toggle ? (
                ...
                {/* buttons */}
                <div
                  className={`flex flex-col gap-3 border-l-2 border-[#540B7B] pl-6 ml-6 ${
