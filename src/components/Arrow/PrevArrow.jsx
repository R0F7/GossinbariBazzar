    ...
    <div
      className={
        isTrue
          ...
          : ` h-14 w-14 absolute top-1/2 -left-20 transform -translate-y-1/2 rounded-full text-[#212B36] flex items-center justify-center shadow-md text-xl hover:bg-[#2E8DD8] hover:text-white transition duration-500 ${typeof onClick === "function" ? "bg-[#FFFFFF]" : "bg-[#2E8DD8] text-white"}`
      }
      onClick={onClick}
    >
