    ...
    <div
      className={
        isTrue
          ...
          : isQuickView
          ? "h-5 w-7 bg-[#2E8DD8] text-white rounded-sm shadow-[#2e8ed893] shadow-md active:scale-90 scale-100 duration-200 absolute -top-9 left-[39%] flex items-center justify-center text-xl"
